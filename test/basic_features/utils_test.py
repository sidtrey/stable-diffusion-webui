...
class UtilsTests(unittest.TestCase):
  def setUp(self):
    self.url_options = "http://10.0.0.118:7860/sdapi/v1/options"
    self.url_cmd_flags = "http://10.0.0.118:7860/sdapi/v1/cmd-flags"
    self.url_samplers = "http://10.0.0.118:7860/sdapi/v1/samplers"
    self.url_upscalers = "http://10.0.0.118:7860/sdapi/v1/upscalers"
    self.url_sd_models = "http://10.0.0.118:7860/sdapi/v1/sd-models"
    self.url_hypernetworks = "http://10.0.0.118:7860/sdapi/v1/hypernetworks"
    self.url_face_restorers = "http://10.0.0.118:7860/sdapi/v1/face-restorers"
    self.url_realesrgan_models = "http://10.0.0.118:7860/sdapi/v1/realesrgan-models"
    self.url_prompt_styles = "http://10.0.0.118:7860/sdapi/v1/prompt-styles"
    self.url_artist_categories = "http://10.0.0.118:7860/sdapi/v1/artist-categories"
    self.url_artists = "http://10.0.0.118:7860/sdapi/v1/artists"
